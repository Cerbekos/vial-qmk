...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,             KC_Y,    KC_U,    KC_I,    KC_O,    L2_P,
        KC_A,    KC_S,    KC_D,    KC_F,    KC_G,             KC_H,    KC_J,    KC_K,    L3_L,    L1_ENT,
        MS_Z,    MA_X,    KC_C,    MG_V,    KC_B,    KC_F24,  KC_N,    KC_M,    KC_COMM, KC_DOT 
    ),
    [1] = LAYOUT(
